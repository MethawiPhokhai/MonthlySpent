import type { BudgetData, GitHubConfig } from '../types/budget'

const API_BASE = 'https://api.github.com'
const FILE_PATH = 'data/budget.json'
...
export async function fetchBudgetFile(
  ...
  const response = await fetch(`${API_BASE}/repos/${config.owner}/${config.repo}/contents/${FILE_PATH}`, {
    headers: {
